...
HD_PWD='C:/Users/Asus/Vivado_Projects/RISC-V-processor/Risc_V_Multicycle/Risc_V_Multicycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_V_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_V_top.tcl
